...
## KNOWN ISSUES
- You CAN'T use custom emojis offline because the script connects to Discord CDN to retrieve them
- The sound listening menu is broken
- Don't put 2 sounds at the same time in the script, it will break everything
- Don't run the script if you have the final video playing, it will give an error

## Features 

-  **Automatic Message Rendering** - Generate Discord-style message images from text
-  **Sound Effect Integration** - Add impact sounds and join notifications (You can put your own sounds into assets\sounds\mp3 and use them in the script)
-  **Video Compilation** - Create seamless MP4 videos with proper timing
-  **Script Validation** - Built-in script error checking
-  **Custom Discord emojis** - Use the emojis right from Discord by copying their emoji ID into the text script
...
6. **Discord Emojis**
    - Paste the emoji like this: `<:youremojiname:1499814372820783294>` and it will turn into a custom emoji
